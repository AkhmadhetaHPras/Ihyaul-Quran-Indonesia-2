        ...
        columnDefs: [{
            ...
            render: function (e, t, a, s) {
                var n = a.invoice_status,
                    l = a.due_date;
                return "<span data-bs-toggle='tooltip' data-bs-html='true' title='<span>" + n + "<br> <strong>Balance:</strong> " + a.balance + "<br> <strong>Due Date:</strong> " + l + "</span>'>" + {
