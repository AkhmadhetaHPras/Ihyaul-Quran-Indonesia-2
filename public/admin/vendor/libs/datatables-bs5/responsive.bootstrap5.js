                ...
                (r = function (e) {
                    return (function (e, t, n, i) {
                        ...
                        e.extend(o.prototype, {
                            ...
                            _resize: function (n) {
                                ...
                                for (i = 0, r = c.length; i < r; i++)
                                    if (
                                        ...
                                        !c[i].never &&
                                        !c[i].control &&
                                        0 == !s.column(i).visible()
                                    ) {
                                        f = !0;
                                        break;
                                    }
                                e(s.table().node()).toggleClass(
                                    "collapsed",
                                    f
                                );
                                var h = !1,
                                ...
                                s
                                    ...
                                    .each(function (e, t) {
                                        !0 === p[t] && m++,
                                            (n || p[t] !== u[t]) &&
                                            ((h = !0),
                                                o._setColumnVis(e, p[t]));
                                    }),
                                    h &&
                                    (this._redrawChildren(),
                                        e(s.table().node()).trigger(
                                            "responsive-resize.dt",
                                            [s, this.s.current]
                                        ),
                                        0 ===
                                        s.page.info().recordsDisplay &&
                                        e("td", s.table().body())
                                            .eq(0)
                                            .attr("colspan", m)),
                                    o._controlClass();
                            ...
                            _resizeAuto: function () {
                                ...
                                if (
                                    ...
                                    if (l) {
                                        var c = e(l.cloneNode(!1)).appendTo(
                                            i
                                        ),
                                            u = t
                                                .columns()
                            ...
                            _setColumnVis: function (t, n) {
                                var i = this.s.dt,
                                    r = n ? "" : "none";
                                e(i.column(t).header()).css("display", r),
                                    e(i.column(t).footer()).css(
                                        "display",
                                        r
                                    ),
                                    i
                        ...
                        function a(e, t, n) {
                            ...
                            if (s[r]) {
                                for (
                                    var o = e.cell(t, n).node(),
                                    a = s[r][0].parentNode.childNodes,
                                    d = [],
                                    l = 0,
                                    c = a.length;
                                    l < c;
                    ...
                    return (function (e, t, n, i) {
                        ...
                        return (
                            ...
                            (r.ext.renderer.pageButton.bootstrap =
                                function (t, o, s, a, d, l) {
                                    var c,
                                        u,
                                        p,
                                        f = new r.Api(t),
                                        h = t.oClasses,
                                        m = t.oLanguage.oPaginate,
                                        v =
