                            ...
                            return (function (t, e, n, a) {
                                var r,
                                    ...
                                    s = function (e) {
                                        (this.$ = function (t, e) {
                                            ...
                                            (this.fnSortListener = function (
                                                t,
                                                e,
                                                n
                                            ) {
                                                this.api(!0).order.listener(
                                                    t,
                                                    e,
                                                    n
                                                );
                                ...
                                function A(e) {
                                    ...
                                    t.each(e, function (t, o) {
                                        (n = t.match(/^([^A-Z]+?)([A-Z])/)) &&
                                            -1 !==
                                                "a aa ai ao as b fn i m o s ".indexOf(
                                                    n[1] + " "
                                                ) &&
                                            ((a = t.replace(
                                                n[0],
                                ...
                                function O(e, n, r) {
                                    ...
                                    var p =
                                            -1 !==
                                            t.inArray("asc", o.asSorting),
                                        g =
                                            -1 !==
                                            t.inArray("desc", o.asSorting);
                                    o.bSortable && (p || g)
                                        ? p && !g
                                            ? ((o.sSortingClass =
                                                  i.sSortableAsc),
                                ...
                                function ot(e, a, r, o) {
                                    ...
                                    if (null === d.nTr) {
                                        ...
                                        he(e, "aoRowCreatedCallback", null, [
                                            i,
                                            h,
                                            a,
                                            p,
                                ...
                                function ft(e) {
                                    ...
                                    (e.nHolding = r[0]),
                                        (e.nTableWrapper = i[0]),
                                        (e.nTableReinsertBefore =
                                            e.nTable.nextSibling);
                                    for (
                                        var l,
                                            u,
                                            c,
                                ...
                                function pt(e, n, a) {
                                    ...
                                    var i,
                                        ...
                                        s = e.oInstance,
                                        u = function (t) {
                                            he(e, null, "xhr", [e, t, e.jqXHR]),
                                                a(t);
                                        };
                                    if (t.isPlainObject(l) && l.data) {
                                        var c =
                                            "function" == typeof (i = l.data)
                                                ? i(n, e)
                                                : i;
                                        (n =
                                            "function" == typeof i && c
                                ...
                                function jt(t, e) {
                                    ...
                                    return e
                                        ...
                                        .replace(
                                            /_END_/g,
                                            n.call(t, t.fnDisplayEnd())
                                        )
                                        .replace(
                                            /_MAX_/g,
                                            n.call(t, t.fnRecordsTotal())
                                        )
                                        .replace(/_TOTAL_/g, n.call(t, o))
                                        .replace(
                                            /_PAGE_/g,
                                            n.call(t, i ? 1 : Math.ceil(a / r))
                                        )
                                        .replace(
                                            /_PAGES_/g,
                                            n.call(t, i ? 1 : Math.ceil(o / r))
                                        );
                                }
                                function Nt(t) {
                                    var e,
                                ...
                                function Mt(e) {
                                    for (
                                        ...
                                        s[0][u] = new Option(
                                            "number" == typeof l[u]
                                                ? e.fnFormatNumber(l[u])
                                                : l[u],
                                            i[u]
                                        );
                                    var f = t("<div><label/></div>").addClass(
                                        n.sLength
                                    );
                                    return (
                                        e.aanFeatures.l ||
                                    ...
                                    (e.scrollBarVis = V),
                                        ...
                                        Xt(function (t, e) {
                                            (t.innerHTML =
                                                ...
                                                E[e] +
                                                "</div>"),
                                                (t.childNodes[0].style.height =
                                                    "0"),
                                                (t.childNodes[0].style.overflow =
                                                    "hidden"),
                                                (t.style.width = O[e]);
                                        }, o),
                                        R &&
                                        ...
                                        (m.width = Zt(c)),
                                        R &&
                                            (e.nScrollFoot.style.width = Zt(c)),
                                        g ||
                                            (N &&
                                                (C.height = Zt(
                                                    L.offsetHeight + b
                                ...
                                function Xt(t, e, n) {
                                    for (
                                        var a, r, o = 0, i = 0, l = e.length;
                                        i < l;

                                    ) {
                                        for (
                                            a = e[i].firstChild,
                                                r = n ? n[i].firstChild : null;
                                            a;
                                ...
                                function ie(e, n, r) {
                                    ...
                                    if (e.oFeatures.bStateSave) {
                                        var u = e.fnStateLoadCallback.call(
                                            e.oInstance,
                                            e,
                                            s
                                        );
